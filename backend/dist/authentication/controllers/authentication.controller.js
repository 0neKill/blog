...
let AuthenticationController = class AuthenticationController {
    ...
    async authentication(dto) {
        return this._authenticationService.authentication(dto);
    }
};
__decorate([
    (0, common_1.Post)('registration'),
    __param(0, (0, common_1.Body)(pipes_1.RegistrationPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [__types__1.RegisterDto]),
    __metadata("design:returntype", Promise)
], AuthenticationController.prototype, "registration", null);
__decorate([
    (0, common_1.Post)('sing_in'),
    __param(0, (0, common_1.Body)(pipes_1.AuthenticationPipe)),
    __metadata("design:type", Function),
